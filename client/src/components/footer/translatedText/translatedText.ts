...
export const getRulesInnerText = (language: language) => language === EN
    ...
    : language === RU
        ? 'Проект не является коммерческим и направлен исключительно на образовательные цели. Мы уважаем авториские права, поэтому в случае обнаружения нарушений просим незамедлительно сообщить о них, пройдя по ссылке на поддержку. Приятного чтения.'
